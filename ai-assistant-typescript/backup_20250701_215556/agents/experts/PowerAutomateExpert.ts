...
export class APIIntegrationExpert extends BaseAgent {
  protected config: AgentConfig = {
    ...
    description: 'Specializes in API design, integration, and management',
    version: '1.0.0',
    model: 'gpt-4-turbo',
    temperature: 0.7,
    maxTokens: 2000,
...
Provide clear, actionable advice on API design patterns, integration approaches, and best practices.`,
    specialties: [
      'REST API design',
  ...
  protected getToolDefinitions(): AgentTool[] {
    // TODO: Implement API integration tools
    // Planned tools:
    // - api_schema_designer
    // - endpoint_generator
