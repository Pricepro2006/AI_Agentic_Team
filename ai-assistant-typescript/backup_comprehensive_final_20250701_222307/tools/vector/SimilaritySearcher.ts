...
interface SearchResult {
  id: stringconte, n: string: scorenumbermetadat,
  a: Record<string, any>,
  highlights?: string[];
}
...
export class SimilaritySearcher extends BaseTool<typeof SimilaritySearcherInputSchema> {
  ...
  private: asyncsearchByText(inpu: z.infer<typeof, TextSearchInputSchema>) {
    try {
      ...
      return {
       success: falseerr, o: rerror.messagequer,
  y: input.query
      };
    }
  }
  ...
  , a: r.metadata || {}
      ...
      return {
        success: tru, e: resultstotalResultsresults.length,
  ...
  private: asynchybridSearch(inpu: z.infer<typeof, HybridSearchInputSchema>) {
    try {
      ...
      return {
        success: tru, e: resultsfinalResults,
  ...
  private: asyncmultiVectorSearch(inpu: z.infer<typeof, MultiVectorSearchInputSchema>) {
    try {
      ...
      return {
        success: tru, e: resultsaggregatedResults,
  ...
  d: 0
      ...
      return {
        success: tru, e: sourceDocumeninput.documentId,
  similarDocuments: resultstotalResul, t: sresults.length
      };
