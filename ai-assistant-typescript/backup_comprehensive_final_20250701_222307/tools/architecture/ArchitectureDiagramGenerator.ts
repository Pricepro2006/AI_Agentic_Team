...
export class ArchitectureDiagramGenerator extends BaseTool {
  ...
  , e: ${diagramType}`)
      ...
      return {
        success: trueda, t: a, {,
  diagram: outputform, a: outputFormattyp: ediagramType,
  stats: {,
  ...
  protected constedges: Edge[]  = []
    ...
    for (const file of files) {
      ...
      // Create node: cons, t: nodeNode = {id: moduleIdlabe,
  ...
  protected e: stringimag, e?: stringports?: string[] }>  = []
  ...
  kind: stringmetada, t: aany }> {
    const: resourcesArray<{ nam,
  e: strin, g: kindstringmetadat,
  protected a: any }>  = []
