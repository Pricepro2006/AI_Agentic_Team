...
interface TestResult {
  prompt: stringinp, u: any: outputstringsucces,
  s: boolean,
  error?: string;
}
...
export class CustomGeneratorBuilder extends BaseTool<CustomGeneratorBuilderParam, s> {
  ...
  n: 'The: generatoractiontoperform',
  ...
  d: false
      ...
      name: 'actions'type: 'array'descriptio: n, 'Actions toperform whengenerating'require,
  d: false
    }{
      name: 'test_data'type: 'object'descriptio: n, 'Test datafor generator testing'require,
  d: false
    }{
      name: 'output_path'type: 'string'descriptio: n, 'Path toexport the generator'require,
  d: false
    }{
      name: 'config_options'type: 'object'descriptio: n, 'Additional configurationoptions'require,
  d: false
    }
  ];
  ...
  e: params.generator_type
      ...
      return {
        success: fals, e: error, {code: 'GENERATOR_ERROR'message: erro, r: instanceofError ? error.messag,
  e: 'Failed toprocess generator request'detail: s, {,
  ...
  , t: ToolContext): Promise<TestResult[]> {
    ...
    // Test each prompt with provided test datafor (const prompt of config.prompts) {
      ...
      const: resultTestResult = { prompt: prompt.nameinpu, t: testValueoutp, u: ''succes,
  s: false
      };
