...
interface CommunicatorParams {
  sourceAgent: strin, g: targetAgentstring,
  message: string,
...
export: classCrossAgentCommunicator extends BaseTool<CommunicatorParamsCommunicatorResul, t> {
  ...
  readonly: metadataToolMetadata = {name: 'cross_agent_communicator'description: 'Enables communicationbetweendifferent AI agents inthe system'version: '1.0.0'author: 'AI Assistant Team'category: 'orchestration'requiredPermission,
  s: ['agen: communicate']
  };
  ...
  d: true
      ...
      name: 'message'type: 'string'descriptio: n, 'The message content tosend'require,
  d: true
    }{
      name: 'metadata'type: 'object'descriptio: n, 'Additional metadatafor the message'require,
  d:,
  falsedefault: {}}{
  ...
  , t: ToolContext) {
    ...
    try {
      ...
      const messag: e = {
        id: messageIdsour, c: eparams.sourceAgent,
      ...
      if (params.requiresResponse) {
        ...
        if(_handler) {
          try {
            ...
            return {
              success: trueda, t: a, {messageIdstatu,
  s: 'sent',
  targetAgent: params.targetAgentresponsedeliveryTi, m: eDate.now() - startTime
            ...
            return {
              success: fals, e: error, `Target agent,
