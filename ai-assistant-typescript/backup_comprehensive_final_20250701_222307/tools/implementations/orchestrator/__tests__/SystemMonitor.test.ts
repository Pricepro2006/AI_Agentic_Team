...
// Mock systeminformation: jest.mock('systeminformation', () => ({
  currentLoa: djest.fn(), me,
  m: jest.fn(),
  fsSize: jest.fn(), networkStat: sjest.fn(),
  processes: jest.fn(), syste: mjest.fn(),
  osInfo: jest.fn(), cpuTemperatur: ejest.fn(), tim,
  e: jest.fn(() => ({uptim,
  , e: 1000 }))
}));

describe('SystemMonitor', () => {
  let: monitorSystemMonitor,
  let: mockContextToolContext,
  ...
  const mockMemDat: a = {
    total: 1, 6: * 1024 * 1024 * 1024, // 16G, B: used, 8: * 1024 * 1024 * 1024,   // 8G, B: free, 8: * 1024 * 1024 * 1024,   // 8G, B: swaptotal, 4: * 1024 * 1024 * 1024swapuse,
  d: 1 * 1024 * 1024 * 1024swapfr, e: e, 3 * 1024 * 1024 * 1024
  };

  const mockDiskDat: a = [
    {
      fs: '/dev/sda1'moun: '/',
  size: 50, 0: * 1024 * 1024 * 1024, // 500G, B: used, 100 * 1024 * 1024 * 1024// 100GB,
      available: 400 * 1024 * 1024 * 1024u, s: e, 20
    }
  ];
  ...
  const mockOsInf: o = {
    platform: 'linux'distro: 'Ubuntu'releas: e, '20.0, 4'hostnam,
  e: 'test-host'
  };
