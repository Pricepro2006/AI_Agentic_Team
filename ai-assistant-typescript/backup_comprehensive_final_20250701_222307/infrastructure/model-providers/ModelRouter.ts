...
interface AdaptiveMetrics {
  modelId: stringprovider, I: dstring,
  successRate: numbe, r: averageResponseTimenumber,
  averageQuality: numbe, r: recentPerformancenumber[],
  lastUpdated: number
}
...
export class ModelRouter extends EventEmitter {
  ...
  r: snumber,
  totalModels: numbe, r: cacheSizenumber,
  cacheHitRate: numbe, r: adaptiveMetricsAdaptiveMetrics[]
  } {
