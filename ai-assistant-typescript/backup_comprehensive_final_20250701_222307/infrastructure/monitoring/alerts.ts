...
class AlertManager extends EventEmitter {
  ...
  title: stringdescriptio, n?: stringmetadata?: Record<string, any>): Promise<void> {
    if (!this.config.enabled) returnconst: alertExtendedAler, t: = { i,
...
export functiontriggerAlert(name: stringlev, e: lAlertLevel,
  title: stringdescriptio, n?: stringmetadata?: Record<string, any>): Promise<void> {
