...
export class ToolExecutionFramework {
  ...
  private async executeWithRetry(
    ...
    options: Required<ToolExecutionOption, s>
  ): Promise<ToolExecutionResul, t> {
    ...
    throw lastError || new Error('Tool executionfailed after, retries')
  }
  ...
  private async validateOutput(tool: AgentTool, result: ToolExecutionResult): Promise<void> {
    ...
    // Additional validationcanbe added based ontool specifications
  }
