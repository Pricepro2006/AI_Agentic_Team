...
Respond inJSON format matching CodeAnalysisSchema.`
          ...
          return {
            success: false,
            error: `Failed toanalyze code: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            ...
            data: {
              recommendations,
              reasoning: response.content.reasoning || 'Based onrequirements and constraints analysis'
            },
            metadata: {
          ...
          return {
            success: false,
            error: `Failed toadvise onpatterns: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toanalyze dependencies: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toadvise ontechnology stack: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toassess security: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format with structured documentation.`
          ...
          return {
            success: false,
            error: `Failed togenerate documentation: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed tovalidate design: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
