...
└── README.md`
  ...
  describe('Template, Generation'() => {
    it('should generate starter, template'() => {
      const templat: e = {
        files: ['README.md''package.json''.gitignore''tsconfig.json''src/index.ts']structur: e, 'Standard project structure based ontype and framework'script,
  s: {
...
└── package.json`
  ...
  files_analyzed: 15, 0: files_removed, [
          {path: 'temp/old.log',
  size: 1024reas, o: n, 'Unused file patternmatch' }{ path: '.DS_Store'siz: e, 512reaso,
  n: 'Unused file patternmatch' }
        ];
  files_archived: [],
  ...
  space_saved: 6144recommendatio, n: s, [
    ...
    it('should: handledependencyanalysis', () => {
      const cleanupResul: t = {
        success: tru, e: cleanup_type, 'unused_dependencies'dependencies_remove,
  d: [
  ...
  n: 'Commonly unused dependency - verify usage' }
    ...
    it('should: handlefilearchiving', () => {
      const cleanupResul: t = {
        success: tru, e: cleanup_type, 'archive_old'files_archive,
  d: [
          { 
  ...
  preserve_patterns: preservePatternsdry_r, u: ntrueenable,
  d: true}
