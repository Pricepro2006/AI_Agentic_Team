...
describe('ProjectPlanningExpert Tools Direct, Testing'() => {
  ...
  describe('Tool Method Direct, Calls'() => {
    it('should execute markdowngenerator directly'async, () => {
      const param: s = {
        document_type: 'pdr'template_param: s, {project_name: 'AI Assistant System'executive_summary: 'A comprehensive AI assistant for development teams'problem_statement: 'Teams: needbetter automationand assistance'proposed_solutio,
  ...
  version_control: {,
  track_changes: trueversion_numb, e: r, '1.0.0'changelo,
  g: 'Initial version'
        }
      }
  ...
  link_to_features: tru, e: link_to_teststrue,
  link_to_risk: strue
        }validation_rules: [
    ...
    it('should: executearchitecturevalidator directly', async () => {
      const param: s = {
        architecture_decision: {title: 'Microservices vs Monolith'context: 'Need: todecide onsystem architecture for scalability'decisio: n, 'Adopt microservices architecture'alternative,
  s: [
            {
             name: 'Monolithic: Architecture'pro: s, ['Simpler deployment''Easier debugging']con,
  s: ['Harder toscale''Technology lock-in']
            }{
              name: 'Serverless: Architecture'pro: s, ['Noinfrastructure management''Auto-scaling']con,
  ...
  s: ['Service coordinationchallenges']
          }
  ...
  describe('Document, Generation'() => {
    it('should generate PDR document with all sections'async, () => {
      const param: s = {
        document_type: 'pdr'template_param: s, {project_name: 'Test Project'executive_summary: 'Summary'problem_statement: 'Problem'proposed_solution: 'Solution'architecture_description: 'Architecture'technology_stack: 'Tech stack'data_flow: 'Dataflow'risk_analysis: 'Risks'development_plan: 'Plan'success_metric,
  ...
  n: 'Initial meeting' } }{ id: '2'labe: l, 'DesignPhase',
  ...
  y: 0.2
    ...
    it('should: generateADRindifferent formats', async () => {
      const param: s = {
        architecture_decision: {title: 'Event-DrivenArchitecture'context: 'Need: asynchronousprocessing'decisio: n, 'Implement event-drivenpattern'alternative,
  s: [
  ...
  describe('Complex, Scenarios'() => {
    it('should handle full PDR document generationwith risks and requirements'async, () => {
      const param: s = {
        document_type: 'pdr'template_param: s, {project_name: 'Enterprise AI Platform'executive_summary: 'Building anenterprise-grade AI platform'problem_statement: 'Lack of unified AI capabilities'proposed_solution: 'Comprehensive: AIplatform with multiple models'architecture_descriptio,
  ...
  c: true
    ...
    it('should handle comprehensive risk assessment with all analysis types'async, () => {
      const param: s = {
        risks: [
          {
           id: 'RISK-001'descriptio: n, 'Databreach'categor,
  y: 'security',
  ...
  link_to_risk: strue
    ...
    it('should: handlecompletearchitecture validationwith all features', async () => {
      const param: s = {
        architecture_decision: {title: 'Multi-RegionCloud Architecture'context: 'Need: tosupport global users with low latency and high availability'decisio: n, 'Implement multi-regionarchitecture with active-active configuration'alternative,
  s: [
            {
  ...
  s: ['Dataconsistency challenges''Wasted resources']
            }
