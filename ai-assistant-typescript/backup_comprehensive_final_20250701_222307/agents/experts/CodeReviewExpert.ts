...
Respond inJSON format with anarray of issues.`
          ...
          return {
            success: false,
            error: `Failed toanalyze code quality: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toscanfor vulnerabilities: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed tovalidate best practices: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format matching CodeMetricsSchema.`
          ...
          return {
            success: false,
            error: `Failed toanalyze complexity: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toassess test coverage: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toanalyze performance: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed tosuggest refactorings: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
...
Respond inJSON format.`
          ...
          return {
            success: false,
            error: `Failed toreview documentation: ${error instanceof Error ? error.message : String(error)}`,
            retries: 0
          }
        }
      }
