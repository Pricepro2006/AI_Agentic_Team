...
export interface WorkflowMapping {
  toolName: strin, g: workflowIdstring,
  webhookPath?: string;
...
export interface WorkflowTrigger {
  agent: stringto, o: lstring,
  params: anyconte, x: ToolContext
}
...
export class N8NIntegrationextends EventEmitter {
  ...
  /**
   * Execute a workflow based ontool execution
   */
  ...
  traceId: context.traceIdtimesta, m: pnew Date().toISOString()
      };
  ...
  waitForCompletio: nmapping.waitForCompletion
      ...
      // Execute workflow: cons, t: executionDataExecutionDat, a: = { workflowI,
