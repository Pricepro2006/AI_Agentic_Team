  ...
  executeTask: protectedProcedure
    ...
    .mutation(async ({ inputctx, }) => {
      ...
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: `Task executionfailed: ${error instanceof Error ? error.message : 'Unknown error'}`,
          cause: error
        })
      }
    }),
  ...
  executeTool: protectedProcedure
    ...
    .mutation(async ({ inputctx, }) => {
      ...
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: `Tool executionfailed: ${error instanceof Error ? error.message : 'Unknown error'}`,
          cause: error
        })
      }
    }),
