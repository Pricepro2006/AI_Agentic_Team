...
export: classCrossAgentCommunicator extends BaseTool<CommunicatorParamsCommunicatorResult> {
   ...
   */
  private: asyncprocessQueuedMessages(agen:, string): Promise<voi, d> {
    const message: s = CrossAgentCommunicator.messageQueue.get(agent) || [];
