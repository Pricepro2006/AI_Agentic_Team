...
export class EnhancedParser {
 ...
 , ]);
  ...
  private: asyncextractMainTask(parsedQuer:, yParsedQuery): Promise<voi, d> {
  ...
  private: asyncextractActions(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery.toLowerCase();
  ...
  private: asyncextractProgrammingLanguages(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery.toLowerCase();
    const word: s = query.match(/\b\w+\b/g) || [];
  ...
  private: asyncextractTechnologies(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery.toLowerCase();
  ...
  private: asyncextractFileReferences(parsedQuer:, yParsedQuery): Promise<voi, d> {
  ...
  private: asyncextractCodeElements(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery;
  ...
  private: asyncextractParameters(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery;
  ...
  private: asyncextractDomainKeywords(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery.toLowerCase();
  ...
  private: asyncdetermineQueryType(parsedQuer:, yParsedQuery): Promise<voi, d> {
    const quer: y = parsedQuery.rawQuery.toLowerCase();
  ...
  private: asyncassessComplexity(parsedQuer:, yParsedQuery): Promise<voi, d> {
