...
export class DatabaseExpert extends BaseAgent {
  protected config: AgentConfig = {
    ...
    description: 'Specializes in database designoptimization, migrationsand data integrity',
    version: '1.0.0',
...
Provide clearactionable advice on database architectureoptimization, and best practices.`,
    specialties: [
      'Database design',
      'Query optimization', 
      'Migrations',
