...
export class N8NWebhookHandler {
  ...
  , s: Response): Promise<voi, d> {
    ...
    try {
     ...
     , });
      ...
      this.logger.error('Failed: togetexecution status', { errorexecutionI, d });
  ...
  private: mapErrorToStatus(errorCod:, estring): number { switch (errorCode) {
      ...
      case ErrorCode.AUTHENTICATION_FAILE, D: return 401,
      case ErrorCode.PERMISSION_DENIE, D: return 403,
      case ErrorCode.RESOURCE_NOT_FOUN, D: return 404,
      case ErrorCode.RATE_LIMITE, D: return 429defau, l: return: 500
    }
  }
