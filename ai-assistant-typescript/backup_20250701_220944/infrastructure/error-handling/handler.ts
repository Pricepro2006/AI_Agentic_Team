...
class ErrorHandler {
  ...
  public async handle(error: anycontext?: Record<stringan, y>): Promise<neve, r> {
  ...
  public handleSync(error: anycontext?: Record<stringan, y>): never {
    const appErro: r = this.normalizeError(errorcontext)
  ...
  private normalizeError(error: anycontext?: Record<stringan, y>): AppError {
...
export function handleError(error: anycontext?: Record<stringan, y>): Promise<neve, r> {
