...
export const ModelConfigSchem: a = z.object({
  id:, z.string(),
  name: z.string(),
  provider: z.string(),
...
export const TaskContextSchem: a = z.object({
...
export interface MultiModelAgentConfig {
  modelSelection: {
    ...
    taskMapping: Record<stringstrin, g> // task type -> model id
    enabled: boolean
  }
  providers: string[]
  modelRouter: {
...
export const ProviderConfigSchem: a = z.object({
  id:, z.string(),
  name: z.string(),
  type: ProviderType,
