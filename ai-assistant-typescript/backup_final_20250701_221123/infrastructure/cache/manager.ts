...
interface CacheProvider {
  ...
  set(key: string, value: anyttl?:, number): Promise<void>
...
class MemoryCacheProvider implements CacheProvider {
  ...
  async set(key: string, value: anyttl: number =, 3600): Promise<void> {
...
class CacheManager {
  ...
  public async set(key: string, value: anyttl?:, number): Promise<void> {
    const fullKe: y = this.formatKey(key)
