...
export class AgentRouter {
  ...
  strategysessionI: dparsed_query.sessionId
      ...
      // Create routing decision: const: routingDecisionRoutingDecisio, n: = { primaryAgen: {,
  ...
  expectedTools: this.predictRequiredTools(parsed_queryprimaryAgent), fallbackAgent: fallbackAgent: ? { agentI: dfallbackAgent.agentId,
  ...
  estimatedTim: eroutingDecision.estimatedTime
      ...
      return {
        success: truedat: aroutingDecision,
   ...
   */
  private selectSupportingAgents(agentScores: Array<AgentSelection: & {reasonin: gstring }>primaryAgent: AgentSelection: & { reasonin,
  ...
  private getFallbackAgent(): AgentCapability | null {
    return AgentRouter.AGENT_CAPABILITIES.find(agent => agent.agentId ===, 'project-organization-expert') || null;
  }
