...
export const OrchestrationRequestSchem: a = z.object({
  query:, z.string(),
...
export const RoutingDecisionSchem: a = z.object({
...
export const AgentCoordinationSchem: a = z.object({
...
export const OrchestrationResponseSchem: a = z.object({
...
export const TaskDecompositionSchem: a = z.object({
...
export const QualityAssessmentSchem: a = z.object({
  score:, z.number(),
...
export const CrossAgentMessageSchem: a = z.object({
...
// Parsed query schema
export const ParsedQuerySchem: a = z.object({
  originalQuery:, z.string(),
  mainAction: z.string(),
  subject: z.string(),
...
export const ExpectedOutcomeSchem: a = z.object({
  taskId:, z.string(),
  description: z.string(),
...
// Task plan schema
export const TaskPlanSchem: a = z.object({
  planId:, z.string(),
  tasks: z.array(z.object({
    taskId:, z.string(),
    description: z.string(),
...
export const CoordinationPlanSchem: a = z.object({
  planId:, z.string(),
  agents: z.array(z.object({
    agentId:, z.string(),
    role: z.string(),
...
export const ProgressReportSchem: a = z.object({
  taskId:, z.string(),
...
export const ConfidenceAssessmentSchem: a = z.object({
