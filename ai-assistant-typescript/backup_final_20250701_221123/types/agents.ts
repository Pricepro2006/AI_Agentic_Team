...
export const AgentResponseSchem: a = z.object({
  response:, z.string(),
  agentId: z.string(),
  agentName: z.string(),
...
export const AgentToolSchem: a = z.object({
  name:, z.string(),
  description: z.string(),
  parameters: z.object({
...
// Context schema
export const AgentContextSchem: a = z.object({
...
export const PerformanceMetricsSchem: a = z.object({
...
// Agent metadata
export const AgentMetadataSchem: a = z.object({
