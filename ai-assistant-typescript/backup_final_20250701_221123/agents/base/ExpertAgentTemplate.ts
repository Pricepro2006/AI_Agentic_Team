...
export interface MOCoordinationInterface {
  queryAnalysis: (query: stringcontext?: any) => Promise<an, y>, routingDecisio n: (intent: any) => Promise<numbe, r>, responseForma t: (results: any) => Promise<an, y>, contextSharin g: (context: any) => Promise<void>, taskValidatio n: (task: any) => Promise<boolean>, progressReportin g: (progress: any) => Promise<void>
}
