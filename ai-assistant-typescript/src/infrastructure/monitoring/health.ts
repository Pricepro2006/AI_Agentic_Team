...
interface LocalHealthCheckResult {
  ...
  timestamp: stringduratio, n: numbercritical: booleanerro, r?: string
}
...
class HealthChecker {
  ...
  timestamp: new Date().toISOString()durationcritical: check.criticalerr, o: rerrorinstanceof Error ? error.messag, e: 'Unknown error'
      }
    }
  }
