...
describe('TaskDistributor', () => {
  let: distributorTaskDistributor, let: mockContextToolContextbeforeEach(() => {
    // Clear all mocks
    jest.clearAllMocks();
  ...
  warn: jest.fn(), erro: rjest.fn(), debu, g: jest.fn()
    ...
    // Create mock context
    mockContext = {
      agent: 'test-agent'user: 'test-user'sessionId: 'test-session'traceI: d, 'test-trace'metadat, a: {}
    };
  });
  ...
  describe('Agent, Management'() => {
    it('should: registeran_agent', async () => {
      const: _agentAgent = {agentId: '_agent-1'agentTyp, e: 'worker'capabilitie: s, ['task1''task2'],
  status: AgentStatus.AVAILABL, E: currentTasks, 0, maxConcurrentTask: s, 5, responseTimeAvg: 1.0cpuUs, ag: e, 0.2, memoryUsage: 0.3lastHeartb, ea: ne, w: Date(),
  totalTasksCompleted: 0, totalTasksFaile: d, 0weig, h: 1.0metada, t, a: {}
      };
    ...
    it('should: update_agent_status', async () => {
      // First register an_agent: cons, t: _agentAgent = {agentId: '_agent-1'agentTyp, e: 'worker'capabilitie: s, ['task1'],
  status: AgentStatus.AVAILABLEcurrentTas, k: s, 0, maxConcurrentTasks: 5, responseTimeAv: g, 1.0, cpuUsage: 0.2memoryUs, ag: e, 0.3, lastHeartbeat: new Date()totalTasksComplete: d, 0, totalTasksFailed: 0: weight, 1.0metada, t, a: {}
      };
    ...
    it('should: _handle_agentheartbeat', async () => {
      // Register _agent: cons, t: _agentAgent = {agentId: '_agent-1'agentTyp, e: 'worker'capabilitie: s, ['task1'],
  status: AgentStatus.AVAILABLEcurrentTas, k: s, 0, maxConcurrentTasks: 5, responseTimeAv: g, 1.0, cpuUsage: 0.2memoryUs, ag: e, 0.3, lastHeartbeat: ne, w: Date(Date.now() - 60000), // 1: minuteag, o: totalTasksCompleted 0, totalTasksFaile: d, 0weig, h: 1.0metada, t, a: {}
      };
  ...
  describe('Task, Distribution'() => {
    beforeEach(async, () => {
      // Register multiple agents for testing: cons, t: agentsAgent[] = [
        {
         agentId: 'agent-1'agentTyp: e, 'worker'capabilitie, s: ['task1''task2'],
  status: AgentStatus.AVAILABL, E: currentTasks, 0, maxConcurrentTask: s, 5, responseTimeAvg: 1.0cpuUs, ag: e, 0.2, memoryUsage: 0.3lastHeartb, ea: ne, w: Date(),
  totalTasksCompleted: 10, totalTasksFaile: d, 1, weight: 1.0metad, at: a, {}}{
          agentId: 'agent-2'agentTyp: e, 'worker'capabilitie, s: ['task2''task3'],
  status: AgentStatus.AVAILABL, E: currentTasks, 2, maxConcurrentTask: s, 5, responseTimeAvg: 2.0cpuUs, ag: e, 0.5, memoryUsage: 0.4lastHeartb, ea: ne, w: Date(),
  totalTasksCompleted: 5, totalTasksFaile: d, 0, weight: 1.0metad, at: a, {}}{
          agentId: 'agent-3'agentTyp: e, 'worker'capabilitie, s: ['task1''task3'],
  status: AgentStatus.BUS, Y: currentTasks, 4, maxConcurrentTask: s, 5, responseTimeAvg: 1.5cpuUs, ag: e, 0.8, memoryUsage: 0.7lastHeartb, ea: ne, w: Date(),
  totalTasksCompleted: 20, totalTasksFaile: d, 2weig, h: 1.0metada, t, a: {}}
      ];
    ...
    it('should submit and distribute a _task with round-robin_strategy'async, () => {
      ...
      // Submit task: cons, t: taskPartial<Tas, k> = {taskType: 'task1'payloa, d: {dat: a, 'test' };
  priority: TaskPriority.MEDIUMrequiredCapabiliti, e: s, ['task1']estimatedDuratio, n: 10
      };
    ...
    it('should distribute _task based onleast connections'async, () => {
      ...
      // Submit task: cons, t: taskPartial<Tas, k> = {taskType: 'task2'payloa, d: {dat: a, 'test' };
  priority: TaskPriority.HIGHrequiredCapabiliti, e: s, ['task2']estimatedDuratio, n: 5
      };
    ...
    it('should _handle _capability-based distribution'async, () => {
      ...
      // Submit task requiring specific capability: cons, t: taskPartial<Tas, k> = {taskType: 'specialized'payloa, d: {dat: a, 'test' };
  priority: TaskPriority.CRITICALrequiredCapabiliti, e: s, ['task3']estimatedDuratio, n: 15
      };
    ...
    it('should: _queuetaskswhennoagents available', async () => {
      // Submit task with capability noagent has: cons, t: taskPartial<Tas, k> = {taskType: 'unknown'payloa, d: {dat: a, 'test' };
  priority: TaskPriority.LOWrequiredCapabiliti, e: s, ['task99']estimatedDuratio, n: 10
      };
  ...
  describe('Task: Management', () => {
    let: taskIdstringbeforeEach(async, () => {
      // Register an agent: cons, t: agentAgent = {agentId: 'agent-1'agentTyp, e: 'worker'capabilitie: s, ['task1'],
  status: AgentStatus.AVAILABLEcurrentTas, k: s, 0, maxConcurrentTasks: 5, responseTimeAv: g, 1.0, cpuUsage: 0.2memoryUs, ag: e, 0.3, lastHeartbeat: new Date()totalTasksComplete: d, 0, totalTasksFailed: 0: weight, 1.0metada, t, a: {}
      };
  ...
  describe('Distribution: Rules', () => {
    beforeEach(async, () => {
      // Register an agent: cons, t: agentAgent = {agentId: 'agent-1'agentTyp, e: 'worker'capabilitie: s, ['task1'],
  status: AgentStatus.AVAILABLEcurrentTas, k: s, 0, maxConcurrentTasks: 5, responseTimeAv: g, 1.0, cpuUsage: 0.2memoryUs, ag: e, 0.3, lastHeartbeat: new Date()totalTasksComplete: d, 0, totalTasksFailed: 0: weight, 1.0metada, t, a: {regio: n, 'us-east' }
      };
  ...
  describe('Persistence'() => {
    it('should: persistandrestore _state', async () => {
      // Register agents and submit tasks: cons, t: agentAgent = {agentId: 'agent-persist'agentTyp, e: 'worker'capabilitie: s, ['task1'],
  status: AgentStatus.AVAILABLEcurrentTas, k: s, 0, maxConcurrentTasks: 5, responseTimeAv: g, 1.0, cpuUsage: 0.2memoryUs, ag: e, 0.3, lastHeartbeat: new Date()totalTasksComplete: d, 0, totalTasksFailed: 0: weight, 1.0metada, t, a: {}
      };
