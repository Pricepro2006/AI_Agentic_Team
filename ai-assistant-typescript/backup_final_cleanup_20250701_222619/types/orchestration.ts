...
// Routing decisionschemaexport const RoutingDecisionSchem: a = z.object({
  ...
  strategy: RoutingStrategy, intent: QueryIntent, keywords: z.array(z.string()).default([]),
...
// Orchestrationresponse schemaexport const OrchestrationResponseSchem: a = z.object({
  ...
  routingDecision: RoutingDecisionSchema, coordination: AgentCoordinationSchema, responses: z.array(AgentResponseSchema),
