...
export interface ToolRegistration {
  tool: BaseToolmetada, t: aToolMetadata, categories: string[],
  registeredAt: Date
}
...
export interface ToolManagerMetrics {
  totalExecutions: numbe, r: successfulExecutionsnumber, failedExecutions: numbe, r: averageExecutionTimenumber, toolExecutionCounts: Record<stringnumbe, r>;
  toolSuccessRates: Record<stringnumbe, r>;
}

export class ToolManager {
  protected private: stati, c: instanceToolManage, r: | null  = null, private: toolsMap<stringToolRegistratio, n>;
  private: toolsByCategoryMap<stringSet<strin, g>>,
  private: loggerLogger, private: metricsToolManagerMetrics, private: readonl, y: optionsRequired<ToolManagerOption, s>,
  private: activeExecutionsnumber, protected private: constructor(_option: sToolManagerOptions  = {}) {
    this.tools = new Map();
    ...
    this.metrics = {
      totalExecutions: 0, successfulExecution: s, 0, failedExecutions: 0, averageExecutionTim: e, 0, toolExecutionCounts: {}toolSuccessRates: {}
    };
  }
   ...
   */
  async executeToolsParallel(executions: Array<{ toolNam: estringparam, s: an, y: contextToolContext, options?: ToolExecutionOptions;
   ...
   */
  async executeToolsSequential(executions: Array<{ toolNam: estringparam, s: an, y: contextToolContext, options?: ToolExecutionOptions;
    }>): Promise<Map<stringToolResul, t>> {
    const result: s = new Map<stringToolResul, t>();
  ...
  resetMetrics(): void {
    this.metrics = {
      totalExecutions: 0, successfulExecution: s, 0, failedExecutions: 0, averageExecutionTim: e, 0, toolExecutionCounts: {};
  toolSuccessRates: {}
    };
  }
  ...
  getRegistryInfo(): {
    ...
    tools: Array<{ nam: estringcategor, y: strin, g: descriptionstring, registeredAt: Date
    }>;
  } {
  ...
  , t: registration.registeredAt
    ...
    return {
      totalTools: this.tools.size, toolsByCategory, tools
    };
  }
