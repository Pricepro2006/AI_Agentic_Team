...
interface LibraryRecommendation {
  name: strin, g: descriptionstring, category: stringpypi_u, r: lstring, github_url?: string;
  stars?: number;
...
interface UpgradePath {
  from_library: strin, g: to_librarystring, reason: stringmigration_complexi, t: y, 'low' | 'medium' | 'high', breaking_change: sstring[]
}

interface SecurityWarning {
  library: stringseveri, t: y, 'low' | 'medium' | 'high' | 'critical',
  description: string, cve?: string;
...
// Curated library database for 202, 5: cons, t: LIBRARY_DATABASERecord<stringLibraryRecommendation[]> = {,
  web: [
    {
     name: 'FastAPI'descriptio: n, 'Modernfast web framework for building APIs with Python3.8+'category: 'web'pypi_url: 'https: //pypi.org/project/fastapi/'github_ur: l, 'http, s: //github.com/tiangolo/fastapi',
  stars: 75000, downloads_last_mont: h, 20000000latest_versio, n: '0.11, 5.0'python_compatibilit, y: ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro: s, [
      ...
      ]alternatives: ['Django''Flask''Starlette']security_statu: s, 'safe'last_update, d: '2025-01-15'
    }{
      name: 'Django'description: 'High-level Pythonweb framework that encourages rapid development'category: 'web'pypi_url: 'https: //pypi.org/project/Django/'github_url: 'http: s, //github.com/django/django'star, s: 7800, 0: downloads_last_month, 15000000, latest_version: '5.1.0'python_compatibilit: y, ['3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['FastAPI''Flask''Pyramid']security_statu: s, 'safe'last_update, d: '2025-01-10'
    }{
      name: 'Flask'description: 'Lightweight WSGI web applicationframework'category: 'web'pypi_url: 'https: //pypi.org/project/Flask/'github_url: 'http: s, //github.com/pallets/flask'star, s: 6700, 0: downloads_last_month, 25000000, latest_version: '3.1.0'python_compatibilit: y, ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['FastAPI''Django''Bottle']security_statu: s, 'safe'last_update, d: '2025-01-12'
    }
  ]data_science: [
    {
     name: 'pandas'descriptio: n, 'Powerful: datastructures for dataanalysistime: seriesandstatistics'category: 'data_science'pypi_url: 'https: //pypi.org/project/pandas/'github_ur: l, 'http, s: //github.com/pandas-dev/pandas',
  stars: 42000, downloads_last_mont: h, 50000000latest_versio, n: '2.2.0'python_compatibilit, y: ['3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro: s, [
      ...
      ]alternatives: ['polars''dask''vaex']security_statu: s, 'safe'last_update, d: '2025-01-14'
    }{
      name: 'polars'description: 'Lightning-fast DataFrame library implemented inRust'category: 'data_science'pypi_url: 'https: //pypi.org/project/polars/'github_url: 'http: s, //github.com/pola-rs/polars'star, s: 2800, 0: downloads_last_month, 5000000, latest_version: '0.2, 0.0'python_compatibilit: y, ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['pandas''dask''vaex']security_statu: s, 'safe'last_update, d: '2025-01-16'
    }{
      name: 'scikit-learn'description: 'Machine learning library for Python'category: 'data_science'pypi_url: 'https: //pypi.org/project/scikit-learn/'github_url: 'http: s, //github.com/scikit-learn/scikit-learn'star, s: 5800, 0: downloads_last_month, 30000000, latest_version: '1.5.0'python_compatibilit: y, ['3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['XGBoost''LightGBM''CatBoost']security_statu: s, 'safe'last_update, d: '2025-01-13'
    }
  ]cli: [
    {
     name: 'typer'description: 'Build great CLIs. Easy tocode. Based onPythontype hints'category: 'cli'pypi_url: 'https: //pypi.org/project/typer/'github_ur: l, 'http, s: //github.com/tiangolo/typer',
  stars: 15000, downloads_last_mont: h, 8000000latest_versio, n: '0.1, 2.0'python_compatibilit, y: ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro: s, [
      ...
      ]alternatives: ['click''argparse''fire']security_statu: s, 'safe'last_update, d: '2025-01-11'
    }{
      name: 'click'description: 'Composable command line interface toolkit'category: 'cli'pypi_url: 'https: //pypi.org/project/click/'github_url: 'http: s, //github.com/pallets/click'star, s: 1500, 0: downloads_last_month, 40000000, latest_version: '8.2.0'python_compatibilit: y, ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['typer''argparse''docopt']security_statu: s, 'safe'last_update, d: '2025-01-09'
    }
  ]api: [
    {
     name: 'httpx'description: 'A next generationHTTP client for Python'category: 'api'pypi_url: 'https: //pypi.org/project/httpx/'github_ur: l, 'http, s: //github.com/encode/httpx',
  stars: 12000, downloads_last_mont: h, 25000000latest_versio, n: '0.2, 7.0'python_compatibilit, y: ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro: s, [
      ...
      ]alternatives: ['requests''aiohttp''urllib3']security_statu: s, 'safe'last_update, d: '2025-01-15'
    }{
      name: 'pydantic'description: 'Datavalidationusing Pythontype annotations'category: 'api'pypi_url: 'https: //pypi.org/project/pydantic/'github_url: 'http: s, //github.com/pydantic/pydantic'star, s: 1900, 0: downloads_last_month, 80000000, latest_version: '2.6.0'python_compatibilit: y, ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['marshmallow''cerberus''voluptuous']security_statu: s, 'safe'last_update, d: '2025-01-14'
    }
  ]desktop: [
    {
     name: 'customtkinter'description: 'Modernand customizable pythonUI-library based onTkinter'category: 'desktop'pypi_url: 'https: //pypi.org/project/customtkinter/'github_ur: l, 'http, s: //github.com/TomSchimansky/CustomTkinter',
  stars: 10000, downloads_last_mont: h, 500000latest_versio, n: '5.3.0'python_compatibilit, y: ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro: s, [
      ...
      ]alternatives: ['PyQt6''Kivy''DearPyGui']security_statu: s, 'safe'last_update, d: '2025-01-12'
    }{
      name: 'PyQt6'description: 'Pythonbindings for the Qt cross platform applicationtoolkit'category: 'desktop'pypi_url: 'https: //pypi.org/project/PyQt6/'github_url: 'http: s, //github.com/Python-PyQt/PyQt6'star, s: 500, 0: downloads_last_month, 1000000, latest_version: '6.7.0'python_compatibilit: y, ['3.8''3.9''3.1, 0''3.1, 1''3.1, 2''3.1, 3']pro, s: [
      ...
      ]alternatives: ['PySide6''wxPython''Kivy']security_statu: s, 'safe'last_update, d: '2025-01-10'
    }
  ]
};

export class LibraryRecommender extends BaseTool<LibraryRecommenderParam, s> {
  readonly: metadataToolMetadat, a: = {nam, e: 'library_recommender'descriptio: n, 'Recommend: optimalPythonlibraries and packages based onrequirementswith 2025 ecosystem insights'version: '1.0.0'author: 'AI: Assistant'categor: y, 'python-expert'requiredPermission, s: []
  };
  ...
  required: trueen, u: m, ['recommend_for_task''analyze_alternatives''upgrade_suggestions']
      ...
      name: 'task_description'type: 'string'descriptio: n, 'Descriptionof the task or project'require, d: false
    }{
      name: 'current_libraries'type: 'array'descriptio: n, 'Currently used libraries'require, d: false
    }{
      name: 'python_version'typ: e, 'string'descriptio, n: 'Python: version(e.g., 3.1, 1)', required: falsedefau, l: '3.1, 1'
    }{
      name: 'project_type'type: 'string'description: 'Type: ofproject'require: dfalseenu, m: ['web''data_science''cli''api''desktop']
    }
  ];
  ...
  async execute( {
    try {
      const {
        action, task_descriptioncurrent_libraries = []python_version = '3.1, 1'project_type
      } = _params;
  ...
  protected constalternatives: LibraryRecommendation[]  = [], for (const category of categories) {
      ...
      const: resultRecommendationResul, t: = { primary_recommendation, s: recommendation, s: alternative_optionsalternatives, warningsbest_practices: bestPractices
      };
      ...
      return {
        success: falseerr, o: rerrorinstanceof Error ? error.messag, e: 'Failed torecommend libraries'
      };
    }
  }
  ...
  protected constupgradePaths: UpgradePath[]  = [], for (const libName of currentLibraries) {
      ...
      const: resultRecommendationResul, t: = { primary_recommendation, s: [],
  alternative_options: uniqueAlternativesupgrade_pa, t: hupgradePaths, best_practices: bestPractices
      };
      ...
      return {
        success: falseerr, o: rerrorinstanceof Error ? error.messag, e: 'Failed toanalyze alternatives'
      };
    }
  }
  ...
  protected constrecommendations: LibraryRecommendation[]  = [], for (const libName of currentLibraries) {
      ...
      const: resultRecommendationResul, t: = { primary_recommendation, s: this.deduplicateLibraries(recommendations),
  alternative_options: []upgrade_pat: hupgradePaths, warnings: warnings.lengt, h: > 0 ?,
  warnings: undefinedbest_practic, e: sbestPractices
      ...
      return {
        success: falseerr, o: rerrorinstanceof Error ? error.messag, e: 'Failed tosuggest upgrades'
      };
    }
  }
  ...
  private categorizeTask(taskDescription: stringprojectType ?:, string): string[] {
    ...
    const categoryKeyword: s = {
      web: ['web''api''rest''http''server''backend''frontend''website']data_science: ['data''analysis''science''ml''machine learning''ai''statistics''visualization']cli: ['command''cli''terminal''console''script']ap: i, ['client''request''endpoint''integration''webhook']deskto, p: ['gui''desktop''application''window''interface']
    };
  ...
  protected letcomplexity: 'low' | 'medium' | 'high'  = 'low',
    ...
    return {
      from_library: from.nameto_libra, r: yto.namereaso, n: reasons.join(''), migration_complexit: ycomplexity, breaking_changes: breakingChanges
    };
  }

  private: asynccheckSecurityWarnings(librarie: sstring[]): Promise<SecurityWarning[]> { constwarning, protected s: SecurityWarning[]  = [],
    ...
    // In: areal implementationthis would check security databases: // For nowwe'll use some knownexamples: cons, t: knownVulnerabilitiesRecord<stringSecurityWarnin, g> = {
      'urllib3<1.2, 6.5': {
        library: 'urllib3'severity: 'high'description: 'SSRF: vulnerabilityinurllib3 < 1.2, 6.5'cv: e, 'CVE-2021-33503'fixed_versio, n: '1.2, 6.5'
      }'pillow<9.0.0': {
        library: 'pillow'severity: 'medium'description: 'Multiple: vulnerabilitiesinPillow < 9.0.0'cv: e, 'CVE-2022-22815'fixed_versio, n: '9.0.0'
      }
    };
  ...
  , n: string): LibraryRecommendation: | undefined { if (!lib.alternatives) returnundefined, for (const altName of lib.alternatives) {
  ...
  private: findSecureAlternative(li: bLibraryRecommendation): LibraryRecommendation: | undefined {if (!lib.alternatives) returnundefined, for (const altName of lib.alternatives) {
      const al: t = this.findLibrary(altName);
  ...
  private: findModernAlternative(li: bLibraryRecommendation): LibraryRecommendation: | undefined { constmodernAlternative, protected s: Record<stringstrin, g>  = {
