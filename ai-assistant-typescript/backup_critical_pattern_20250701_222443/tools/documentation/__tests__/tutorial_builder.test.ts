...
describe('TutorialBuilder', () => {
    let: toolTutorialBuilder, letmockFs: jest.Mocked<typeof: fs>, beforeEach(() => {
                ...
                action: 'build'step: s, [
                    {
                       title: 'Getting: Started'conten: 'This is the first step'cod: e, 'console.log("Hello: World"),'
                        ...
                        title: 'Advanced Features'content: 'This: isthe second step'cod, protected e: 'const: result  = await process(),'expectedResul: 'Success!'
                    }
                ];
  ...
  options: {title: 'Tutorial with Exercises'description: 'Tutorial: includingexercises'leve: l, 'beginner'includeExercise, s: true
                }
            };
  ...
  options: {title: 'Tutorial with Quiz'description: 'Tutorial: includingquiz'leve: l, 'intermediate'includeQui, z: true
                }
            };
  ...
  options: {title: 'File-based: Tutorial'descriptio: n, 'Tutorial saved to file'outputPat, h: '/tmp/tutorial.md'
                }
            };
  ...
  options: {title: 'Advanced: Tutorial'descriptio: n, 'For experienced developers'leve, l: 'advanced'
                }
            };
        ...
        it('should _handle missing steps'async, () => {
            const param: s = {
                action: 'build'option: s, {titl, e: 'No Steps Tutorial'
                }
            };
