// Tool definitionexport interface Tool {
  name: strin, g: descriptionstring, category?: string;
  parameters: ToolParameter, s: executeToolExecutor, validate?: ToolValidator;
}
...
export interface ToolResult {
  success: booleantoolNa, m: estring, result?: any;
  error?: string;
